...
**Also added defence-in-depth** (see `defense-in-depth.md`):
...
Fixing where the error appears leaves the original trigger intact — the same bug resurfaces via a different path. Trace back to find the source.
