...
- Remove init workflow from obsidian-wiki skill — vault setup is handled manually in Obsidian
- Update workflow prerequisites to reference vault `wiki` directly instead of init workflow

## [1.12.1] - 2026-04-07

### Fixed

- Fix vault verification syntax in obsidian-wiki skill — `obsidian vault vault=wiki` instead of `obsidian vault=wiki`
...
[Unreleased]: https://github.com/jamesacarr/claude/compare/v1.12.1...HEAD
